    ...
    return (
      <button
        ...
        className={clsx(
          ...
          vertical ? 'w-11 h-8 flex-col' : 'w-full h-8 flex-row'
        )}
        title={label}
      >
        {icon ?? <Adjust />}
  ...
  return (
    <label
      ...
      className={clsx(
        ...
        vertical ? 'w-11 h-full min-h-56 flex-col' : 'w-full h-8 min-w-56 flex-row'
      )}
      title={label}
    >
      <div className={clsx('flex items-center justify-center', vertical ? 'h-[calc(1.5rem-2px)] flex-col' : 'w-6 flex-row')}>
        {icon ?? <Adjust />}
      </div>
