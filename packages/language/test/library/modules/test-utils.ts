...
export function getFunctionExport (moduleValue: Value, exportName: string): Function<Schema, FacetType, GlobalScope> {
  ...
  return FunctionFacet.get(exportValue) as Function<Schema, FacetType, GlobalScope>
}
